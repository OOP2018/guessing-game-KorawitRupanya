...
public class NumberGame extends java.util.Observable{
	...
	/**
	 * Return a message about the most recent call to guess(). Initially the message
	 * should tell the user something so the user knows what to guess, such as "I'm
	 * thinking of a number between 1 and xx".
	 * 
